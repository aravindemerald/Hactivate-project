...
while not terminated:
    try:
        ...
        elif audioText == 'location':
            location = geocoder.ip('me')
            lat = str(location.lat)
            lng = str(location.lng)
            web.open('https://www.google.com/maps/@' + lat + ',' + lng + ',16z', new=2)
        ...
        #the code does a google search by default(base case)
        else:
